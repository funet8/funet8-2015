...
$posttags = get_the_tags();
	 if ($posttags) {
		 ...
		 foreach($posttags as $tag) {
			 ...
			 $url = "<a href=\"$link\" title=\"".str_replace('%s',addcslashes($cleankeyword, '$'),__('查看“%s”所有文章'))."\"";
			 $url .= ' target="_blank"';
...
function replacehttp($content){
		if( is_ssl() ){
			$content = str_replace('http://www.funet8.com/wp-content/uploads', 'https://www.funet8.com/wp-content/uploads', $content);
		}
		return $content;
	}
