...
function hui_nav_menu($class='nav', $location='nav'){
	...
	echo '<ul class="nav"><li class="page_item"><a href="/category/linux">linux服务器</a></li><li class="page_item"><a href="/category/video">视频电影</a></li><li class="page_item"><a href="/category/comic">搞笑漫画</a></li><li class="page_item"><a href="/category/experience">经验分享</a></li><li class="page_item"><a href="/category/blog">好玩文字</a></li></ul>';
}
